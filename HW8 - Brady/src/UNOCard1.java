 ...
 */
public class UNOCard1 implements Comparable {
	...
	public UNOCard1(int color, int card) {
	...
	public String toString() {
		...
		switch (color) {
			...
			case NULL:   nameColor = "Black ";       break;
		}
	...
	public int compareTo(Object object) {
		...
		if (!(object instanceof UNOCard1)) throw new ClassCastException("Object is not a card");
		else {
			UNOCard1 carta = (UNOCard1)object;
